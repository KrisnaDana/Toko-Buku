...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Dashboard -->
            <li class="{{ Request::is('adm/analytics')? "active": "" }} nav-item">
                <a class="nav-link" href="{{ route('adm-grafik') }}">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Pengaturan Buku:</h6>
                        <a class=" collapse-item" href="{{ route('adm-buku') }}">Buku</a>
                        <a class="collapse-item" href="{{ route('adm-img-book') }}">Gambar Buku</a>
                        <a class="collapse-item" href="{{ route('adm-book-category') }}">Kategori Buku</a>
                        <a class="collapse-item" href="{{ route('adm-img-book-category-detail') }}">Kategori Detail Buku</a>
                    </div>
                </div>
            </li>

            <li class="{{ Request::is('adm/profil')? "active": "" }} nav-item">
            ...
            <li class="{{ Request::is('adm/transaksi')? "active": "" }} nav-item">
                <a class="nav-link" href="{{route('adm-transaksi')}}">
                    <i class="fas fa-fw fa-poll"></i>
                    <span>Transaksi</span></a>
            </li>

            <li class="{{ Request::is('adm/Courier')? "active": "" }} nav-item">
                <a class="nav-link" href="{{route('adm-courier')}}">
                    <i class="fas fa-fw fa-truck"></i>
                    <span>Kurir</span></a>
            </li>

            <li class="{{ Request::is('adm/Diskon')? "active": "" }} nav-item">
                <a class="nav-link" href="{{route('adm-diskon')}}">
    ...
    <footer class="sticky-footer bg-white">
        <div class="container my-auto">
            <div class="copyright text-center my-auto">
                <span>Copyright &copy; Kelompok 20 2022</span>
            </div>
        </div>
    </footer>
    <!-- End of Footer -->
